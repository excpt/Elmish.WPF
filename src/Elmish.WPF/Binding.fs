...
module Binding =
    ...
    module OneWaySeqT =
        ...
        let id itemEquals (getId: 'a -> 'id) : string -> Binding<_, 'msg, _> =
            OneWaySeq.create itemEquals getId |> createBindingT
    ...
    module Cmd =
        ...
        let internal createWithParam exec canExec autoRequery =
            Cmd.createWithParam exec canExec autoRequery |> createBinding
    ...
    module OneWaySeq =
        ...
        let internal create get itemEquals getId =
            OneWaySeq.create itemEquals getId |> BindingData.mapModel get |> createBinding
    ...
    module SubModelSeqUnkeyedT =
        ...
        let id
            (createVm: ViewModelArgs<'bindingModel, 'msg> -> #IViewModel<'bindingModel, 'msg>)
            : (string
                  -> Binding<'bindingModelCollection, int * 'msg, ObservableCollection<#IViewModel<'bindingModel, 'msg>>>)
            =
            SubModelSeqUnkeyed.create createVm IViewModel.updateModel |> createBindingT
    ...
    module SubModelSeqKeyedT =
        ...
        let id
            ...
            : (string
                  -> Binding<'bindingModelCollection, 'id * 'msg, ObservableCollection<#IViewModel<'bindingModel, 'msg>>>)
            =
    ...
    module SubModelSeqUnkeyed =
        ...
        let internal create createViewModel updateViewModel =
            SubModelSeqUnkeyed.create createViewModel updateViewModel |> createBinding
...
type Binding private () =
    ...
    static member selectedIndex(get: 'model -> int voption, set: int voption -> 'msg) =
        Binding.SelectedIndex.vopt >> Binding.mapModel get >> Binding.mapMsg set
    ...
    static member selectedIndex(get: 'model -> int option, set: int option -> 'msg) =
        Binding.SelectedIndex.opt >> Binding.mapModel get >> Binding.mapMsg set
    ...
    static member oneWay(get: 'model -> 'a) : string -> Binding<'model, 'msg> =
        Binding.OneWay.id<'a, 'msg> >> Binding.addLazy (=) >> Binding.mapModel get
    ...
    static member oneWayOpt(get: 'model -> 'a option) : string -> Binding<'model, 'msg> =
        Binding.OneWay.opt<'a, 'msg> >> Binding.addLazy (=) >> Binding.mapModel get
    ...
    static member oneWayOpt(get: 'model -> 'a voption) : string -> Binding<'model, 'msg> =
        Binding.OneWay.vopt<'a, 'msg> >> Binding.addLazy (=) >> Binding.mapModel get
    ...
    static member oneWayLazy
        (get: 'model -> 'a, equals: 'a -> 'a -> bool, map: 'a -> 'b)
    ...
    static member oneWayToSource(set: 'a -> 'model -> 'msg) : string -> Binding<'model, 'msg> =
        Binding.OneWayToSource.id<'model, 'a> >> Binding.mapMsgWithModel set
    ...
    static member oneWayToSourceOpt(set: 'a option -> 'model -> 'msg) : string -> Binding<'model, 'msg> =
        Binding.OneWayToSource.opt >> Binding.mapMsgWithModel set
    ...
    static member oneWayToSourceOpt(set: 'a voption -> 'model -> 'msg) : string -> Binding<'model, 'msg> =
        Binding.OneWayToSource.vopt >> Binding.mapMsgWithModel set
    ...
    static member twoWay
        (get: 'model -> 'a, set: 'a -> 'model -> 'msg, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.twoWay (get, set) >> Binding.alterMsgStream wrapDispatch
    ...
    static member twoWayOpt
        (get: 'model -> 'a option, set: 'a option -> 'model -> 'msg)
        : string -> Binding<'model, 'msg> =
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member twoWayOpt
        (get: 'model -> 'a option, set: 'a option -> 'model -> 'msg, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.twoWayOpt (get, set) >> Binding.alterMsgStream wrapDispatch
    ...
    /// <param name="set">Returns the message to dispatch.</param>
    static member twoWayOpt
        (get: 'model -> 'a voption, set: 'a voption -> 'model -> 'msg)
        : string -> Binding<'model, 'msg> =
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member twoWayOpt
        (get: 'model -> 'a voption, set: 'a voption -> 'model -> 'msg, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.twoWayOpt (get, set) >> Binding.alterMsgStream wrapDispatch
    ...
    static member twoWayValidate
        (get: 'model -> 'a, set: 'a -> 'model -> 'msg, validate: 'model -> string list)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.id<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    /// </param>
    static member twoWayValidate
        (get: 'model -> 'a, set: 'a -> 'model -> 'msg, validate: 'model -> string voption)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.id<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    /// </param>
    static member twoWayValidate
        (get: 'model -> 'a, set: 'a -> 'model -> 'msg, validate: 'model -> string option)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.id<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    /// </param>
    static member twoWayValidate
        (get: 'model -> 'a, set: 'a -> 'model -> 'msg, validate: 'model -> Result<'ignored, string>)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.id<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    static member twoWayOptValidate
        (get: 'model -> 'a voption, set: 'a voption -> 'model -> 'msg, validate: 'model -> string list)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.vopt<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    /// </param>
    static member twoWayOptValidate
        (get: 'model -> 'a voption, set: 'a voption -> 'model -> 'msg, validate: 'model -> string voption)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.vopt<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    /// </param>
    static member twoWayOptValidate
        (get: 'model -> 'a voption, set: 'a voption -> 'model -> 'msg, validate: 'model -> string option)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.vopt<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    /// </param>
    static member twoWayOptValidate
        (get: 'model -> 'a voption, set: 'a voption -> 'model -> 'msg, validate: 'model -> Result<'ignored, string>)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.vopt<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    /// </param>
    static member twoWayOptValidate
        (get: 'model -> 'a option, set: 'a option -> 'model -> 'msg, validate: 'model -> string list)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.opt<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    /// </param>
    static member twoWayOptValidate
        (get: 'model -> 'a option, set: 'a option -> 'model -> 'msg, validate: 'model -> string voption)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.opt<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    /// </param>
    static member twoWayOptValidate
        (get: 'model -> 'a option, set: 'a option -> 'model -> 'msg, validate: 'model -> string option)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.opt<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    /// </param>
    static member twoWayOptValidate
        (get: 'model -> 'a option, set: 'a option -> 'model -> 'msg, validate: 'model -> Result<'ignored, string>)
        : string -> Binding<'model, 'msg> =
        Binding.TwoWay.opt<'a>
        >> Binding.addLazy (=)
        >> Binding.mapModel get
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmd
        (exec: 'model -> 'msg, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmd exec >> Binding.alterMsgStream wrapDispatch
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmdIf
        (exec: 'model -> 'msg, canExec: 'model -> bool, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmdIf (exec, canExec) >> Binding.alterMsgStream wrapDispatch
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmdIf
        (exec: 'model -> 'msg voption, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmdIf exec >> Binding.alterMsgStream wrapDispatch
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmdIf
        (exec: 'model -> 'msg option, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmdIf exec >> Binding.alterMsgStream wrapDispatch
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmdIf
        (exec: 'model -> Result<'msg, 'ignored>, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmdIf exec >> Binding.alterMsgStream wrapDispatch
    ...
    static member cmdParam
        (exec: obj -> 'model -> 'msg, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmdParam exec >> Binding.alterMsgStream wrapDispatch
    ...
    static member cmdParamIf
        (exec: obj -> 'model -> 'msg, canExec: obj -> 'model -> bool, ?uiBoundCmdParam: bool)
        : string -> Binding<'model, 'msg> =
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmdParamIf
        (exec: obj -> 'model -> 'msg, canExec: obj -> 'model -> bool, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmdParamIf (exec, canExec) >> Binding.alterMsgStream wrapDispatch
    ...
    /// </param>
    static member cmdParamIf
        (exec: obj -> 'model -> 'msg voption, ?uiBoundCmdParam: bool)
        : string -> Binding<'model, 'msg> =
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmdParamIf
        (exec: obj -> 'model -> 'msg voption, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmdParamIf exec >> Binding.alterMsgStream wrapDispatch
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmdParamIf
        (exec: obj -> 'model -> 'msg voption, uiBoundCmdParam: bool, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
    ...
    /// </param>
    static member cmdParamIf
        (exec: obj -> 'model -> 'msg option, ?uiBoundCmdParam: bool)
        : string -> Binding<'model, 'msg> =
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmdParamIf
        (exec: obj -> 'model -> 'msg option, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmdParamIf exec >> Binding.alterMsgStream wrapDispatch
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmdParamIf
        (exec: obj -> 'model -> 'msg option, uiBoundCmdParam: bool, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmdParamIf (exec, uiBoundCmdParam)
        >> Binding.alterMsgStream wrapDispatch
    ...
    /// </param>
    static member cmdParamIf
        (exec: obj -> 'model -> Result<'msg, 'ignored>, ?uiBoundCmdParam: bool)
        : string -> Binding<'model, 'msg> =
        Binding.Cmd.createWithParam
    ...
    [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
    static member cmdParamIf
        (exec: obj -> 'model -> Result<'msg, 'ignored>, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
        : string -> Binding<'model, 'msg> =
        Binding.cmdParamIf exec >> Binding.alterMsgStream wrapDispatch
    ...
    static member subModel
        (getSubModel: 'model -> 'subModel, bindings: unit -> Binding<'model * 'subModel, 'msg> list)
        : string -> Binding<'model, 'msg> =
        Binding.SubModel.required bindings
        >> Binding.mapModel (fun m -> (m, getSubModel m))
    ...
    static member subModelSeq // TODO: make into function
        (getBindings: unit -> Binding<'model, 'msg> list, getId: 'model -> 'id)
...
module Extensions =
    ...
    type Binding with
        ...
        static member oneWayToSource(set: 'a -> 'msg) : string -> Binding<'model, 'msg> =
            Binding.OneWayToSource.id<'model, 'a> >> Binding.mapMsg set
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member twoWay
            (get: 'model -> 'a, set: 'a -> 'msg, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.twoWay (get, set) >> Binding.alterMsgStream wrapDispatch
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member twoWayOpt
            (get: 'model -> 'a option, set: 'a option -> 'msg, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.twoWayOpt (get, set) >> Binding.alterMsgStream wrapDispatch
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member twoWayOpt
            (get: 'model -> 'a voption, set: 'a voption -> 'msg, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.twoWayOpt (get, set) >> Binding.alterMsgStream wrapDispatch
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member cmd
            (exec: 'msg, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.cmd exec >> Binding.alterMsgStream wrapDispatch
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member cmdIf
            (exec: 'msg, canExec: 'model -> bool, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.cmdIf (exec, canExec) >> Binding.alterMsgStream wrapDispatch
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member cmdParam
            (exec: obj -> 'msg, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.cmdParam exec >> Binding.alterMsgStream wrapDispatch
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member cmdParamIf
            (exec: obj -> 'msg voption, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.cmdParamIf exec >> Binding.alterMsgStream wrapDispatch
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member cmdParamIf
            (exec: obj -> 'msg voption, uiBoundCmdParam: bool, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.cmdParamIf (exec, uiBoundCmdParam)
            >> Binding.alterMsgStream wrapDispatch
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member cmdParamIf
            (exec: obj -> 'msg option, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.cmdParamIf exec >> Binding.alterMsgStream wrapDispatch
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member cmdParamIf
            (exec: obj -> 'msg option, uiBoundCmdParam: bool, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.cmdParamIf (exec, uiBoundCmdParam)
            >> Binding.alterMsgStream wrapDispatch
        ...
        /// </param>
        static member cmdParamIf
            (exec: obj -> Result<'msg, 'ignored>, ?uiBoundCmdParam: bool)
            : string -> Binding<'model, 'msg> =
            Binding.Cmd.createWithParam
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member cmdParamIf
            (exec: obj -> Result<'msg, 'ignored>, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.cmdParamIf exec >> Binding.alterMsgStream wrapDispatch
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member cmdParamIf
            (exec: obj -> Result<'msg, 'ignored>, uiBoundCmdParam: bool, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.cmdParamIf (exec, uiBoundCmdParam)
            >> Binding.alterMsgStream wrapDispatch
        ...
        /// </param>
        static member cmdParamIf
            (exec: obj -> 'msg, canExec: obj -> bool, ?uiBoundCmdParam: bool)
            : string -> Binding<'model, 'msg> =
            Binding.Cmd.createWithParam
        ...
        [<System.Obsolete("In version 5, this method will be removed.  Use the overload without the \"wrapDispatch\" parameter followed by a call to \"Binding.alterMsgStream\".  For an example, see how this method is implemented.")>]
        static member cmdParamIf
            (exec: obj -> 'msg, canExec: obj -> bool, wrapDispatch: Dispatch<'msg> -> Dispatch<'msg>)
            : string -> Binding<'model, 'msg> =
            Binding.cmdParamIf (exec, canExec) >> Binding.alterMsgStream wrapDispatch
